export function RecoveryComponent(container) {
    ...
    content.innerHTML = `
        <div class="flex flex-col gap-4 mb-8 md:flex-row md:items-start md:justify-between">
            <div>
                <h2 class="text-3xl font-bold text-primary mb-2">Recovery</h2>
                <p class="text-gray-400">Recover funds from failed or stuck coinswaps</p>
            </div>
            <button
                id="manual-recovery-btn"
                class="shrink-0 bg-primary hover:bg-primary-hover text-white font-bold px-5 py-3 rounded-xl transition-all border border-primary shadow-lg shadow-black/30 hover:shadow-xl hover:scale-[1.02]"
            >
                Trigger Recovery
            </button>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-surface rounded-lg p-6">
                ...
                <div class="grid gap-4 sm:grid-cols-3">
                    <div class="rounded-lg bg-slate-900/40 p-4">
